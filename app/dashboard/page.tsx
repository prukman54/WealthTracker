...
import { TrendingUp, DollarSign, BarChart3, LogOut, User } from "lucide-react"
          ...
          <div className="mb-8">
            ...
            <div className="bg-card rounded-lg p-4 shadow-sm border border-border">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h3 className="font-semibold text-card-foreground mb-2">Profile Summary</h3>
                  <div className="space-y-1 text-sm text-muted-foreground">
                    ...
                    <p>
                      <span className="font-medium">Currency:</span> {getCurrencyInfo().currency} (
                      {getCurrencyInfo().symbol})
                    </p>
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold text-card-foreground mb-2">Wealth Quote</h3>
            ...
            <Link href="/dashboard/money-flow">
              <Card className="card-hover bg-card border-border cursor-pointer h-full">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl text-card-foreground">💰 Money Flow Tracker</CardTitle>
                ...
                <CardContent className="text-center">
                  ...
                  <Button className="w-full bg-primary hover:bg-primary/90 text-white">Open Money Flow</Button>
                </CardContent>
              </Card>
            </Link>

            <Link href="/dashboard/investing-tools">
              <Card className="card-hover bg-card border-border cursor-pointer h-full">
                <CardHeader className="text-center pb-4">
                  <div className="w-16 h-16 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-4">
                    <BarChart3 className="h-8 w-8 text-accent" />
                  </div>
                  <CardTitle className="text-2xl text-card-foreground">📈 Investing Tools</CardTitle>
                  <CardDescription className="text-muted-foreground">
                ...
                <CardContent className="text-center">
                  ...
                  <Button className="w-full bg-accent hover:bg-accent/90 text-white">Open Investing Tools</Button>
                </CardContent>
              </Card>
            </Link>
          </div>
